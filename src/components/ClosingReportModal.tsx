        ...
        <div className="p-4 sm:p-8 space-y-10">
          ...
          <div className="pt-6 border-t border-white/5 grid grid-cols-1 md:grid-cols-2 gap-10">
             ...
             <div className="flex items-end justify-end">
                <button className="flex items-center gap-2 rounded-2xl bg-accent px-8 py-4 font-black uppercase tracking-widest text-black hover:scale-[1.02] active:scale-95 transition-all shadow-[0_0_20px_rgba(20,255,214,0.3)]">
                   Imprimir Relatório
