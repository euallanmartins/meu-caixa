...
export default function FinanceiroPage() {
  ...
  const { transactions, barbers, currentSession, refreshData } = useDashboardData(profile?.barbearia_id || null);
  ...
  useEffect(() => {
    async function checkUser() {
      try {
        ...
        console.error('[FinanceiroPage] Falha ao validar acesso:', error);
